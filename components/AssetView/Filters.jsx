  ...
  return (
    <div className="w-full mb-4 lg:w-11/12 lg:mt-6 h-[540px] shadow-lg border-r-3 border-gray-200">
      <div className="w-full text-gray-400 bg-white border border-gray-200 border-b-0 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <button
          type="button"
          className="relative inline-flex items-center justify-between w-full px-4 py-4 text-lg font-medium border-b border-gray-200 rounded-t-lg hover:text-gray-600"
        >
          ...
          <div className="py-2">
            <div className="mb-3 w-full">
              <select
                ...
                className="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded-xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:shadow-xl focus:outline-none"
              >
