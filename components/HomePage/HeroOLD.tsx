...
const Hero = () => {
	...
	return (
      ...
      before:right-0 
      before:bottom-0 
      before:bg-[url('https://lh3.googleusercontent.com/DMECLVNnZV6cG6Rj_-gxxutAvF-hXI18TwSnkGX1uNDSpOjB52iN62ozxG1r1nTEdQUodW9GdwwIsOq2vXn8_jie-Uo-_fw1EYsO4g=s550')] 
      before:bg-cover 
      before:bg-center 
      before:opacity-30 
      before:blur"
						...
						<div className={style.infoContainer}>
							...
							<div className={style.author}>
								<div className={style.name}>
									<a href='https://opensea.io/Mikart?tab=created'>Mikart</a>
								</div>
								<a
