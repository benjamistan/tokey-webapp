...
const style = {
	footer: `bg-[#034078] w-screen px-[1.2rem] py-[0.8rem] pt-6 flex text-white relative justify-center flex-wrap items-center mb-10`,
	form: `ml-[0.8rem] grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center text-white`,
	formCTA: `font-bold text-3xl`,
	...
	return (
		<div className={style.footer}>
			<div className={style.form}>
				<div className={style.formCTA}>Join mailing list:</div>
				<div>
