...
const style = {
	container: `block md:flex justify-center bg-[#034078] w-[screen] px-[1.2rem] py-[0.8rem] `,
	logoContainer: `flex items-center cursor-pointer`,
	logoText: ` ml-[0.8rem] text-white font-semibold text-2xl`,
	searchBar: `flex h-10 mx-[0.8rem] items-center bg-[#e5e5e5] rounded-[0.8rem] hover:bg-[#fefcfb]`,
	...
	searchButton: `border bg-[#2081e2] rounded-[0.8rem] p-1 mr-2 font-semibold44sdw cursor-pointer text-black`,
